...
RUN dnf -y --installroot /mnt/rootfs --releasever 8 --setopt=install_weak_deps=false --nodocs install glibc-minimal-langpack coreutils-single libstdc++ zlib ca-certificates
